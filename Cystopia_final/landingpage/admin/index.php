	...
	<body>
		<div id="wrap">
			...
			<?php
				...
				try{
					$db = new PDO('mysql:host=localhost;dbname=cystopia;charset=utf8;','root','', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
				}
				catch(Exception $e){
...
<!--		<a href="http://logout:logout@localhost:8888/Cystopia%20v1.1/landingpage/admin/">logout</a>-->
	</body>
