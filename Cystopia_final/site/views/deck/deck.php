...
//					</div>
					...
					echo "<div class='labelSpan'><a href='?control=deck&action=displayCardOfDeckById&idDeckDisplay=".$val->getId()."&deckNom=".$val->getNom()."&deckHero=".$val->getHero()."''>".' '."
					        <label class='carte_dos' style='left:".$decal."px; background-image: url(./assets/images/heros/".$Hero.");';></label>
							    <p class='nomCarteDeck' >".$nomDeck."</p>
	...
	<div class="new_deck">
		<a class="white tailleLayout" href="?control=deck&action=create">Nouveau Deck</a>
	</div>
<!-- 	
</body>
</html> 
